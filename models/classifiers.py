import keras
from keras.applications import VGG16, MobileNetV2, VGG19,InceptionV3, Xception, ResNet50, EfficientNetB0

def cnn_model(network='resNet50', weights="imagenet", trainable=False, include_top=False):

    print("Getting {} as base network...\n".format(network))

    # use pre-trained models trained on large dataset as base models.
    # Then freeze layers meaning do not update weights/parameters of the layers.
